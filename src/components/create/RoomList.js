...
function RoomList(props){
  ...
  return (
    ...
    Object.keys(props.rooms).map((room, index) => {
      ...
      return <Rooms handleDelete = {props.handleDelete} key= {props.rooms[room].id} id ={props.rooms[room].id} host_id = {props.rooms[room].host_id} room_name={props.rooms[room].room_name} datetime_start={props.rooms[room].datetime_start} datetime_end = {props.rooms[room].datetime_end} handleRoomActivation ={props.handleRoomActivation} />
    })
  )
}
